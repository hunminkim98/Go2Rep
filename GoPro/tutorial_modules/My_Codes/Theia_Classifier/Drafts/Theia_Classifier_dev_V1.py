...
def process_videos(source_dir, target_dir, convert=False, format_choice='avi'):
    """Processes all video trials in the given directory."""
    ...
    for trial_index, trial in enumerate(trials, start=1):
        ...
        for video_path, _ in trial:
            ...
            output_path = os.path.join(trial_target_dir, f"{video_name}.{format_choice}" if convert else video_name)
        ...
        for clip, output_path, _ in video_data:
            trimmed_clip = clip.subclip(0, min_frames / clip.fps)
...
# Main execution
source_dir = r'D:\Theia\Go_Pro_Extrinsic_Calibration_Videos\Raw\Manip05-03-2025\Extrinsic'
target_dir = r'D:\Theia\Go_Pro_Extrinsic_Calibration_Videos\NineCam_PPrime_Lab'
