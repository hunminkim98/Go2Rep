        ...
        if len(columns) >= 2:
            ...
            if link and date_text and date_text != "-":  # Vérification supplémentaire
                try:
                    ...
                    file_extension = os.path.splitext(link['href'])[1].upper()  # Get file extension
...
def download_selected_media_ask_user():
    ...
    # Add a list of formats you prefer
    file_formats = ['.MP4']  # You can add more formats if needed    
