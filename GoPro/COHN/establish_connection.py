...
async def main():
    # Direct input method (airport command is deprecated on macOS)
    print("=" * 50)
    print("GoPro COHN Provisioning Setup")
    print("=" * 50)
    print("\nNote: Make sure your Mac is connected to the target Wi-Fi network")
    print("and the GoPro will be configured to connect to the same network.\n")
    
    ssid = input("Enter Wi-Fi SSID for GoPro to connect: ").strip()
    if not ssid:
