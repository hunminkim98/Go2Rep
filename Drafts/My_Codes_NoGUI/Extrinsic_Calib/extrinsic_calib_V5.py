...
def qca_write(qca_path, C, S, D, K, R, T, binning_factor, pixel_size):
    ...
    for c in range(len(C)):
        cam = etree.SubElement(cams, 'camera', active='1', pointcount='999999999', avgresidual='0.', serial=C[c], model='Miqus Video Plus', viewrotation='0')
...
def calib_toml_to_qca_func(input_file, output_file=None, binning_factor=1, pixel_size=5.54e-3):
    ...
    qca_write(output_file, C, S, D, K, R, T, binning_factor, pixel_size)
