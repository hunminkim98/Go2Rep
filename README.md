...
1. Click on the installation link to download the anaconda environment : ([Link1](https://drive.google.com/file/d/1sXM7SYr03VyQOskW2x5Of3cj5IBftGFn/view?usp=sharing))
...
If you want, you can download the Go2Rep example by clicking on this link:  
[Link1](https://drive.google.com/file/d/1Wv62sN7fTf5F5CKy3CZ9Czl1zty_tcOg/view?usp=sharing)
...
- May suffer from drift and requires careful setup (e.g., GPS off or GPS_SYNC=0).
...
<img src="Assets/gif1.gif" alt="Calibration GIF" width="800" style="display: block; margin: auto;" />
